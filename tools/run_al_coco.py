...
def run(round, run_al):
    ...
    resumepath='/content/drive/MyDrive/PPALVuongTan/PPAL/work_dirs/retinanet_coco_ppal_5rounds_2percent_to_10percent/round8/epoch_20.pth'
    ...
    if run_al:
        ...
        if not (os.path.isfile(round_diversity_image_dis_npy) and args.resume):
            print(round_diversity_image_dis_npy)
