...
init_label_json     = 'data/active_learning/coco_557_labeled_1.json'
init_unlabeled_json = 'data/active_learning/coco_557_unlabeled_1.json'
init_model          = None
